                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-muted/30 sticky top-0 backdrop-blur-md z-10">
                            ...
                            <tr className="border-b border-border">
                                ...
                                <th className="text-right py-1 pr-1 font-medium text-muted-foreground text-xs" style={{ width: '50px' }}>%</th>
                                <th className="text-right py-1 px-3 font-medium text-muted-foreground text-xs">CHF</th>
                                <th className="text-right py-1 pl-6 pr-0 font-medium text-muted-foreground text-xs" style={{ width: '50px' }}>%</th>
                            ...
                            {sortedPositions.map((p) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Daily Performance */}
                                        <td className={cn("py-3 pr-1 text-right font-medium text-xs", isDailyPositive ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400")} style={{ width: '50px' }}>
                                        ...
                                        {/* Total Performance */}
                                        <td className={cn("py-3 pl-6 pr-0 text-right font-medium text-xs", isTotalPositive ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400")} style={{ width: '50px' }}>
                        ...
                        <tfoot className="bg-muted/20 border-t border-border">
                            <tr>
                                ...
                                <td className="py-3 pr-1" style={{ width: '50px' }}></td>
                                ...
                                <td className="py-3 pl-6 pr-0" style={{ width: '50px' }}></td>
