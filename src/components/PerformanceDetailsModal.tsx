...
export function PerformanceDetailsModal({ isOpen, onClose, positions }: PerformanceDetailsModalProps) {
    ...
    return (
        <div className="fixed top-16 bottom-0 left-0 right-0 bg-black/50 flex items-center justify-center z-50 p-4" style={{ left: 'var(--sidebar-width, 0px)' } as React.CSSProperties}>
