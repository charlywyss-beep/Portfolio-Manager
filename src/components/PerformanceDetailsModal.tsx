                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-muted/30 sticky top-0 backdrop-blur-md z-10">
                            ...
                            <tr className="border-b border-border">
                                ...
                                <th className="text-right py-1 px-2 font-medium text-muted-foreground text-xs">%</th>
                                <th className="text-right py-1 px-3 font-medium text-muted-foreground text-xs">CHF</th>
                                <th className="text-right py-1 pl-12 pr-2 font-medium text-muted-foreground text-xs">%</th>
                            ...
                            {sortedPositions.map((p) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Total Performance */}
                                        <td className={cn("py-3 pl-12 pr-2 text-right font-medium text-xs", isTotalPositive ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400")}>
                        ...
                        <tfoot className="bg-muted/20 border-t border-border">
                            <tr>
                                ...
                                <td className="py-3 pl-12 pr-2"></td>
