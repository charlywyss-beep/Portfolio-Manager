                ...
                <div className="overflow-x-auto">
                    <table className="w-auto text-xs text-left">
                        <thead className="bg-muted/50 text-muted-foreground text-xs uppercase tracking-wider font-semibold border-b border-border">
                            <tr>
                                <th className="px-2 py-3 sticky left-0 z-20 bg-card shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)] w-[140px] min-w-[140px]">Bank / Institut</th>
                                <th className="px-2 py-3 min-w-[120px]">Konto-Typ</th>
                                <th className="px-4 py-3 text-right whitespace-nowrap min-w-[100px]">Vermögen</th>
                                <th className="px-4 py-3 w-[300px]">Fortschritt 2025</th>
