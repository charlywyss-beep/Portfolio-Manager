                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-border">
                                    <th className="text-left py-3 px-4 font-semibold sticky left-0 z-40 bg-card shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)] min-w-[120px] md:w-[100px] md:max-w-[100px]">Aktie</th>
                                    ...
                                    watchlistStocks.map((stock) => {
                                        ...
                                        return (
                                            <tr key={stock.id} className="hover:bg-muted/50 transition-colors group">
                                                <td className="py-3 px-4 sticky left-0 z-20 group-hover:bg-muted/30 transition-colors shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)] min-w-[120px] md:w-[100px] md:max-w-[100px] align-top">
