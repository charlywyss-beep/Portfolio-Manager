                        ...
                        <div className="overflow-x-auto overscroll-x-none">
                            <table className="w-full text-sm text-left">
                                <thead className="bg-muted/50 text-muted-foreground text-xs uppercase tracking-wider border-b border-border">
                                    <tr>
                                        <th className="px-4 py-3 sticky -left-px z-20 bg-card shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)]" style={{ width: '180px', minWidth: '140px', maxWidth: '180px' }}>Aktie</th>
                                        ...
                                        watchlistStocks.map((stock) => {
                                            ...
                                            return (
                                                <tr key={stock.id} className="group hover:bg-muted/30 transition-colors">
                                                    <td className="px-4 py-3 sticky -left-px z-10 group-hover:bg-muted/30 transition-colors shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)]" style={{ width: '180px', minWidth: '140px', maxWidth: '180px' }}>
                                                    ...
                                                    <td className="text-center py-3 px-1 w-[60px] min-w-[60px] max-w-[60px] sticky -right-px z-30 bg-card group-hover:bg-muted transition-colors shadow-[-5px_0_5px_-5px_rgba(0,0,0,0.1)]">
