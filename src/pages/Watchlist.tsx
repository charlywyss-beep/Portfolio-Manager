        ...
        <table className="w-full text-left border-collapse min-w-[1200px] xl:min-w-0 table-fixed">
            <thead>
                <tr className="border-b bg-muted/20">
                    <th className="p-4 font-semibold text-muted-foreground text-xs uppercase tracking-wider whitespace-nowrap sticky -left-px z-20 bg-card shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)] w-[140px] md:w-[150px] min-w-[140px] md:min-w-[150px] max-w-[140px] md:max-w-[150px]">Aktie</th>
                    <th
                ...
                {stocks.map((stock) => {
                    ...
                    return (
                        <tr key={stock.id} className="hover:bg-muted/30 transition-colors group">
                            <td className="p-4 sticky -left-px z-10 group-hover:bg-muted/30 transition-colors shadow-[5px_0_5px_-5px_rgba(0,0,0,0.1)] w-[140px] md:w-[150px] min-w-[140px] md:min-w-[150px] max-w-[140px] md:max-w-[150px]">
