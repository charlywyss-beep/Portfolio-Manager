                    ...
                    <table className="w-full min-w-[1000px]">
                        <thead>
                            <tr className="border-b border-border">
                                ...
                                <th className="text-right py-3 pl-6 pr-2 sticky right-0 bg-card z-10 shadow-[-5px_0_5px_-5px_rgba(0,0,0,0.1)]">Aktion</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                projectedDividends.map((data: any) => {
                                    ...
                                    return (
                                        <tr key={position.id} className="border-b border-border last:border-0 hover:bg-muted/50 transition-colors group">
                                            ...
                                            <td className="text-right py-3 pl-6 pr-2 sticky right-0 bg-card group-hover:bg-muted/30 transition-colors shadow-[-5px_0_5px_-5px_rgba(0,0,0,0.1)]">
                            ...
                            <table className="w-full min-w-[1000px]">
                                <thead>
                                    <tr className="border-b border-border">
                                        ...
                                        <th className="text-right py-3 px-4 font-semibold whitespace-nowrap">Quartalsweise</th>
                                        <th className="text-right py-3 px-4 font-semibold whitespace-nowrap">Jährlich</th>
                                        <th className="text-right py-3 pl-6 pr-2 sticky right-0 bg-card z-10 shadow-[-5px_0_5px_-5px_rgba(0,0,0,0.1)]">Aktionen</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {bankRows.map((data: any) => {
                                        ...
                                        return (
                                            <tr key={data.id} className="border-b border-border last:border-0 hover:bg-muted/50 transition-colors group">
                                                ...
                                                <td className="text-right py-3 pl-6 pr-2 sticky right-0 bg-card group-hover:bg-muted/50 transition-colors shadow-[-5px_0_5px_-5px_rgba(0,0,0,0.1)]">
                                                    <div className="flex items-center justify-end gap-1">
                                                        <button
